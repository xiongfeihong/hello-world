...
<div class="business_size_content">
  ...
  <div class="ctn_box">
    <div class="chart_content">
      <div class="btn_box">
        <div class="ft_btn">
          <span class="round lt" v-for="(typeItem, i) in typeList" :key="i" :class="{round_actived: typeItem.id == type}" @click="toggleType(typeItem)">
            {{typeItem.label}}
          </span>
        </div>
      </div>
...
import {WebsiteLeftChart} from './pieConfig';
const colorArr = [
  '#FF6669',
  '#FFA940',
  '#FFEC3C',
...
export default {
  ...
  methods: {
    build(arr, legendData) {
      ...
      let options = WebsiteLeftChart(arr, legendData, horizontal, right);
